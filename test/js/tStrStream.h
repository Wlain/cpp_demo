...
class TStrStream : private std::basic_streambuf<_Elem>, private std::basic_ostream<_Elem, _Traits>
{
...
public:
    ...
    TStrStream(_Str& szString, const _Elem cTag = 0) :
        std::basic_ostream<_Elem, _Traits>(static_cast<std::basic_streambuf<_Elem>*>(this)), m_pString(&szString), m_nElemCount(0), m_nCurPos((size_t)-1), m_charTag(cTag)
    {
    }

    TStrStream(_Elem* szString, size_t nElemCount, const _Elem cTag = 0) :
        std::basic_ostream<_Elem, _Traits>(static_cast<std::basic_streambuf<_Elem>*>(this)), m_pBuf(szString), m_nElemCount(nElemCount), m_nCurPos(0), m_charTag(cTag)
    {
        m_pBuf[m_nCurPos] = 0;
    }
    ...
    TStrStream(_Elem (&szString)[nElemCount]) :
        std::basic_ostream<_Elem, _Traits>(static_cast<std::basic_streambuf<_Elem>*>(this)), m_pBuf(szString), m_nElemCount(nElemCount), m_nCurPos(0), m_charTag(0)
    {
        m_pBuf[m_nCurPos] = 0;
    }
