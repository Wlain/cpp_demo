...
public:
    enum
    {
        eValue = a < TMin<n...>::eValue ? a : TMin<n...>::eValue
    };
};
...
public:
    enum
    {
        eValue = a > TMax<n...>::eValue ? a : TMax<n...>::eValue
    };
};
...
{
    template <uint32 v, uint32 l>
    struct _A
    {
        enum
        {
            eValue = _A<v * 2, l / 2>::eValue
        };
    };
    template <uint32 v>
    struct _A<v, 0>
...
public:
    enum
    {
        eValue = _A<1, n - 1>::eValue
    };
};
template <>
class TAligenUpTo2Power<0>
{
public:
    enum
    {
...
public:
    enum
    {
        eValue = n ? ((n - 1) / nAligen + 1) * nAligen : 0
    };
};
