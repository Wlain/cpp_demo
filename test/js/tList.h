...
public:
    ...
    public:
        CListNode() :
            m_pPreNode(nullptr), m_pNextNode(nullptr)
        {
        }
...
public:
    ...
    public:
        ...
        iterator& operator++()
        {
            m_pNode = m_pNode ? m_pNode->CListNode::GetNext() : nullptr;
            return *this;
        }
        ...
        iterator& operator--()
        {
            m_pNode = m_pNode ? m_pNode->CListNode::GetPre() : nullptr;
            return *this;
        }
        iterator operator--(int)
        {
