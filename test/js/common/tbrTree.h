...
*				or remove node from a tbrTree. Nodes can be removed directly \n
*				without knowing the parent tbrTree. An object can exist in \n
...
namespace XS
{
	...
	class tbrTree
{
		const tbrTree& operator= ( const tbrTree& );
        tbrTree( const tbrTree& );
		enum { eRed, eBlack, eDoubleBlack };
	public:
		typedef ImpClass CNode;
		typedef tbrTree<CNode> CRBTree;
	...
	class TRBSetNode : 
		public tbrTree< TRBSetNode<DataType> >::CRBTreeNode
	{
	protected:
		DataType	m_Data;
	public:
	...
	class TRBMapNode : 
		public tbrTree< TRBMapNode<KeyType, DataType> >::CRBTreeNode
	{
	protected:
		KeyType		m_Key;
		DataType	m_Data;
