//
// Created by william on 2022/4/16.
//

#ifndef CPP_DEMO_COMMONMACRO_H
#define CPP_DEMO_COMMONMACRO_H
#include "logger.h"
...
#define LOG_HELPER(level, ...) \
    Logger::getInstance().log(level, "[in File:" + std::string(__FILE__) + ":" + std::to_string(__LINE__) + "] " "[" + std::string(__FUNCTION__) + "] [msg]: " + __VA_ARGS__);
